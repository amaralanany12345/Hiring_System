...
namespace Hiring.Migrations
{
    ...
    [Migration("20240926090744_companyEmailAndPassword")]
    partial class companyEmailAndPassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hiring.Models.CV", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hiring.Models.CV", b =>
                {
                    b.HasOne("Hiring.Models.Employee", "employee")
                        .WithOne("employeeCv")
                        .HasForeignKey("Hiring.Models.CV", "employeeId")
